...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder> {
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        final String path = "content://com.example.paras.apfinalproject/demo-pictures/" + mDataSet[position];
        ...
        if (position == 1) {
            holder.mButtonName.setText("Paras Dhawan");
            holder.mButtonNumber.setText("+1(315)378-9211");
            holder.mButtonEmail.setText("pdhawan@syr.edu");
        } else if (position == 0) {
            holder.mButtonName.setText("Ekta Mahajan");
            holder.mButtonNumber.setText("+1(315)751-4946");
            holder.mButtonEmail.setText("emahajan@syr.edu");
        }
    ...
    protected static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.textnameabout)
        protected TextView mButtonName;

        @Bind(R.id.textemailabout)
        protected TextView mButtonEmail;

        @Bind(R.id.textnumeberabout)
        protected TextView mButtonNumber;
