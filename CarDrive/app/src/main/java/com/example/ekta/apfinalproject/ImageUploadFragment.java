...
import com.example.ekta.apfinalproject.MyAccountActivity;
...
public class ImageUploadFragment extends Fragment {
    ...
    public static ImageUploadFragment newInstance(CarData carUser) {
        ...
        continueButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (imageFile.equals("")) {
                    ...
                    Intent myIntent = new Intent(getActivity(), MyAccountActivity.class);
